  ...
  return (
    <section className="relative h-[90vh] min-h-[700px] flex items-center justify-center text-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <div className="absolute -bottom-[80%] left-1/2 -translate-x-1/2 w-[100vw] h-[50vh] max-w-[1200px] bg-primary/50 rounded-full blur-3xl"></div>
      </div>
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          <Button size="lg" className="mt-8">Let's Talk your product</Button>
        </div>
      </div>
