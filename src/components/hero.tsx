  ...
  return (
    <section className="relative h-[90vh] min-h-[700px] flex items-center justify-center text-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/2 left-1/2 w-[80vw] h-[80vw] max-w-[1000px] max-h-[1000px] -translate-x-1/2 -translate-y-1/2 bg-primary/20 rounded-full blur-3xl animate-pulse"></div>
      </div>
