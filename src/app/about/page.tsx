...
import MazeBackground from "@/components/maze-background";
            ...
            <section id="about" className="relative overflow-hidden bg-background py-20 sm:py-24">
                ...
                <div className="container relative z-10 mx-auto px-4">
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <h1 className="font-headline text-4xl font-bold text-primary sm:text-5xl">A Journey Through Design and Continuous Learning</h1>
